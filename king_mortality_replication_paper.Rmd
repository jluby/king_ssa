...
# Discussion
I find that the biases highlighted by Kashin et al. in their companion 2015 papers are not nearly as significant as asserted. This assertion is based upon three observations: 1) The SSA's models closely mirror linear models, implying a belief in a somewhat constant level of progress in longevity extension. As discussed by Kashin et al., the SSA is committed to the creation of consistent forecasting and to this end they have produced a near linear forecast which does not jitter with annual errors. We see that past 2010, true values regress toward linear projections, suggesting this to be a well-guided policy. 2) Kashin et al.'s paper analyze a time period in which an unpredictable boom in life expectancies occurred, causing all models tested to appear biased downward. 3) Kashin et al. primarily make use of Human Mortality Database observed life expectancy values, while the Social Security Administration bases their forecasts on their own data. After the year 2000, these two values diverge with SSA recorded values dipping well below HMD values. These three factors have likely created much of the perceived "bias" suggested by the authors, rather than any faults in forecasting methodology.
